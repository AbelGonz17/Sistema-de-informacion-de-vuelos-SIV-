...
{
    /// <inheritdoc />
    public partial class AgregarNuevasEntidades : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Limpiamos las tablas relacionadas a Vuelo para permitir el cambio de tipo de datos
            migrationBuilder.Sql("DELETE FROM LogAuditorias");
            migrationBuilder.Sql("DELETE FROM Vuelos");
