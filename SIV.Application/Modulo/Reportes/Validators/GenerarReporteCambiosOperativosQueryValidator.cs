...
{
    public class GenerarReporteCambiosOperativosQueryValidator : AbstractValidator<GenerarReporteCambiosOperativosQuery>
    {
        public GenerarReporteCambiosOperativosQueryValidator()
        {
