...
{
    public class ActualizarAeropuertoCommandValidator : AbstractValidator<ActualizarAeropuertoCommand>
    {
        public ActualizarAeropuertoCommandValidator()
        {
            RuleFor(c => c.Id)
                .NotEmpty().WithMessage("El ID del aeropuerto es obligatorio.");
