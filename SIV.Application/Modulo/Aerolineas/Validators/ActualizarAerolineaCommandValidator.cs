...
{
    public class ActualizarAerolineaCommandValidator : AbstractValidator<ActualizarAerolineaCommand>
    {
        public ActualizarAerolineaCommandValidator()
        {
            RuleFor(c => c.Id)
                .NotEmpty().WithMessage("El ID de la aerolínea es obligatorio.");
