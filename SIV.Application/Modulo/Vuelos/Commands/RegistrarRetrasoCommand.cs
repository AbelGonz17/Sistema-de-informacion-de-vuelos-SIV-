...
namespace SIV.Application.Modulo.Vuelos.Commands
{
        ...
        : IRequest<Result<bool>>, IComandoOperativo, IAuditableCommand
    {
        public string ObtenerMensajeAuditoria(object response)
        {
            ...
            {
                return $"Se registró un retraso para el vuelo con ID {VueloId}. Nuevo horario estimado de salida: {NuevaHoraSalida:yyyy-MM-dd HH:mm:ss}. Motivo: {Motivo}.";
            }
            return $"Intento de registrar retraso para el vuelo con ID {VueloId} no fue completado.";
        }
    }
}