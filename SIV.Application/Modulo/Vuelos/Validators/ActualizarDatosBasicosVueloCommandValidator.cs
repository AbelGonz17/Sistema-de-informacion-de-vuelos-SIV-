...
{
    public class ActualizarDatosBasicosVueloCommandValidator : AbstractValidator<ActualizarDatosBasicosVueloCommand>
    {
        public ActualizarDatosBasicosVueloCommandValidator()
        {
            RuleFor(c => c.VueloId)
